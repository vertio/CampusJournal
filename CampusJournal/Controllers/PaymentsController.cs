...
namespace CampusJournal.Controllers
{
    public class PaymentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,StudentIndexNumber,Amount,Date,Status,Description")] Payment payment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,StudentIndexNumber,Amount,Date,Status,Description")] Payment payment)
        {
            if (id != payment.Id)
            {
                return NotFound();
